...
export function LoginGate({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="relative min-h-screen w-screen overflow-visible bg-background text-foreground flex items-center justify-center px-6">
        ...
        <div className="flex flex-col items-center text-center">
            ...
            <div className="mt-8 space-y-4">
              <input
                ...
                placeholder="••••••"
                aria-label="Senha"
                className="w-full h-[41px] rounded-2xl border-2 border-white/10 bg-white/5 px-6 text-2xl tracking-[0.3em] text-white text-center outline-none transition-all duration-200 placeholder:text-white/20 placeholder:tracking-normal focus:border-[oklch(0.78_0.18_155)] focus:bg-white/10 focus:shadow-[0_0_0_4px_oklch(0.78_0.18_155/0.25),0_0_30px_oklch(0.78_0.18_155/0.45)]"
              />
      ...
      <p className="absolute top-4 left-0 right-0 z-10 px-6 text-center text-white/40" style={{ fontSize: "0.72rem" }}>
